        ...
        <div className="md:w-1/2 px-8 md:px-16 py-20 text-center md:text-left">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-blue-600 font-semibold">Simple. Intuitive. Powerful.</p>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <p className="text-blue-600 font-semibold">Made for Nepali learners and developers</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/runner"
              className="inline-flex items-center justify-center bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300  transform hover:-translate-y-0.5"
            >
              Try Abhaya Language
